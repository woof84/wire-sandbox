...
<!-- card 3 - now card 2 -->
 <div class="card">
    ...
    <div class="card-content blue lighten-5">
     ...
     <div id="ideas3"><p><b>Advice for email</b></p>
      <ul><li>Err on the side of formality</li>
       <li>Background familiarity with the assignment, or the faculty member’s work</li>
       <li>Keep your email short</li>
       <li>Make sure you can’t find the information elsewhere and identify where the gaps are (why you are contacting THEM specifically).</li> Show them that you tried to find it yourself. </li>
     ...
     <p><b>Advice for in-person</b></p></li>
      <ul>
